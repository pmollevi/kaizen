...
- Current mark: a geometric "K" isotype in an olive/sage gradient (`KaizenMark`, inline SVG component at `src/components/ui/KaizenMark.tsx`), usable alone or with the "KAIZEN" wordmark. Verde Kaizen (`#7B835C`) is the sole brand accent; electric blue and any glow/glass treatment are retired for good. See `DESIGN.md` for the full system.
